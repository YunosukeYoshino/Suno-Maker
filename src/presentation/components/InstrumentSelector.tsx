...
const INSTRUMENT_CATEGORIES: InstrumentCategory[] = [
  {
    ...
    instruments: [
      ...
      },
      {
        ...
        displayName: "Violin",
        category: "strings",
        tags: ["classical", "folk", "orchestral"],
      },
      {
        id: "viola",
        name: "viola",
      ...
      },
      {
        ...
        displayName: "Cello",
        category: "strings",
        tags: ["classical", "orchestral", "deep"],
      },
      {
        id: "double_bass",
        name: "double bass",
      ...
      },
      {
        ...
        displayName: "Harp",
        category: "strings",
        tags: ["classical", "ethereal", "orchestral"],
      },
      {
        id: "banjo",
        name: "banjo",
    ...
    instruments: [
      {
        ...
        displayName: "Flute",
        category: "winds",
        tags: ["classical", "light", "orchestral"],
      },
      {
        id: "piccolo",
        name: "piccolo",
        displayName: "Piccolo",
        category: "winds",
        tags: ["classical", "high", "orchestral"],
      },
      {
        id: "oboe",
        name: "oboe",
        displayName: "Oboe",
        category: "winds",
        tags: ["classical", "orchestral", "woodwind"],
      },
      {
        id: "clarinet",
        name: "clarinet",
      ...
      },
      {
        ...
        category: "winds",
        tags: ["classical", "orchestral", "brass"],
      },
      {
        id: "trombone",
        name: "trombone",
      ...
      },
      {
        ...
        category: "winds",
        tags: ["classical", "folk", "educational"],
      },
    ],
  },
  {
    ...
    instruments: [
      ...
      },
      {
        ...
        displayName: "Timpani",
        category: "percussion",
        tags: ["classical", "orchestral", "dramatic"],
      },
      {
        id: "xylophone",
        name: "xylophone",
    ...
    instruments: [
      {
        ...
        category: "electronic",
        tags: ["electronic", "modern", "versatile"],
      },
      {
        id: "analog_synth",
        name: "analog synth",
...
const ALL_INSTRUMENTS = INSTRUMENT_CATEGORIES.flatMap(
...
export function InstrumentSelector({
  ...
  const filteredInstruments = useMemo(() => {
    ...
    if (activeCategory !== "all") {
      instruments = instruments.filter(
        (instrument) => instrument.category === activeCategory
      );
    }
  ...
  const handleInstrumentToggle = useCallback(
    (instrumentName: string) => {
      if (selectedInstruments.includes(instrumentName)) {
        // 楽器削除
        onInstrumentChange(
          selectedInstruments.filter((inst) => inst !== instrumentName)
        );
  ...
  const handleRemoveInstrument = useCallback(
    (instrumentToRemove: string) => {
      onInstrumentChange(
        selectedInstruments.filter((inst) => inst !== instrumentToRemove)
      );
    },
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                    {category.instruments
                      ...
                      .map((instrument) => {
                        ...
                        const isDisabled =
                          !isSelected &&
                          selectedInstruments.length >= maxSelection;
                        ...
                        return (
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              handleInstrumentToggle(instrument.name)
                            }
                            disabled={isDisabled}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
              {filteredInstruments
                ...
                .map((instrument) => {
                  ...
                  const isDisabled =
                    !isSelected && selectedInstruments.length >= maxSelection;
